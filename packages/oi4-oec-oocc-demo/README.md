# OI4 OEC data consumer demo oi4-oec-oocc-demo

The oi4-oec-oocc-demo service is a demo service to explain and understand the usage ot the [oi4-oec-service](https://github.com/OI4/oi4-service).
