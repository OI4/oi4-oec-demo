...
oi4App.addSubscription(healthTopic).then();
oi4App.addSubscription(healthSummaryTopic).then();
oi4App.addSubscription(mamTopic).then();
oi4App.addSubscription(mamSummaryTopic).then();
